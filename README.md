...
> Convert Excel files to JSON files as a build task
...
## The "excel_as_json" task

### Overview
In your project's Gruntfile, add a section named `excel_as_json` to the data object passed into `grunt.initConfig()`.
